  ...
  return (
    ...
    <div className='
      ...
      <div className='  w-screen h-screen '>
        <div className=' w-full h-full items-center flex justify-center overflow-x-hidden bg-green-500 flex-col'>
            ...
            <span className="relative">
                ...
                <span
                className="{`${styles.cursor} absolute -bottom-0 left-0 -top-1 inline-block bg-green-500 w-full animate-type will-change`}"
                ></span>
            </span>
            </h1>
        </div>
